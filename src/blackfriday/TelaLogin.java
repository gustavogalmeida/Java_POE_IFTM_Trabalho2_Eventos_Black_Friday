...
public class TelaLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Login Black Friday");
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        String nome, senha, adm;
        nome = txtEmpresa.getText();
        senha = txtSenha.getText();
        adm = txtAdministrador.getText();
        if ("IFTM Patrocinio".equals(nome) && "xpto123".equals(senha)){
            JOptionPane.showMessageDialog(null, "Login efetuado com sucesso! Bem vindo <<administrador "+adm+">>.");
            dispose();
            TelaCadastro n = new TelaCadastro();
            n.show();
        } else {
